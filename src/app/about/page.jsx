...
import profilePic from "../../../public/display-photo/profile-moin.jpg";
      ...
      <main className="flex w-full flex-col items-center justify-center">
        <Layout className="pt-16">
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8 ">
            ...
            >
              <h2 className="mb-4 text-lg font-bold uppercase dark:text-light/75">
                Biography
              </h2>
              <p className="font-medium">
                Hi, I'm Moin Afzal, a web developer with a passion for creating
                beautiful, functional, and user-centered digital experiences.
                With 2 plus years of experience in the field. I am always
              ...
              <p className="font-medium">
                While I'm working on a website, I bring my commitment to design
