...
import profilePic from "../../public/display-photo/developer-pic-1.png";
import AnimatedText from "@/components/AnimatedText";
import Link from "next/link";
import { LinkArrow } from "@/components/Icons";
import HireMe from "@/components/HireMe";
import lightBult from "../../public/display-photo/miscellaneous_icons_1.svg";
  ...
  return (
    <>
      ...
      <main className="flex items-center text-dark w-full min-h-screen dark:text-light">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <div className="flex items-center self-start mt-2 lg:self-center">
                <Link
                  ...
                  hover:dark:border-light md:text-base md:p-2 md:px-4"
                  download={true}
                >
                  Resume <LinkArrow className="w-6 ml-1" />
                </Link>
                <Link
                  href="mailto:mmafzal.fcc@outlook.com"
                  target={"_blank"}
                  className="ml-4 text-lg font-medium capitalize text-dark underline 
                  md:text-base dark:text-light"
                >
                  Contact
                </Link>
              </div>
        ...
        <HireMe />
        <div className="absolute right-16 bottom-8 inline-block w-24 md:hidden">
          <Image src={lightBult} alt="Moin Afzal" className="w-full h-auto" />
        </div>
      </main>
    </>
  );
